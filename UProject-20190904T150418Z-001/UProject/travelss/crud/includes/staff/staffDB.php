...
class staff extends databaseconnect{
 ...
 public function saveStaff($tbName,$firstname,$lastname,$nic,$email,$username,$password)
 {
 $con=$this->connect();
 mysqli_query($con,"insert into $tbName values('','".$firstname."','".$lastname."','".$nic."','".$email."','".$username."','".$password."')");
...
echo '<thead>'; 
echo "<tr ><th>Staff Id</th><th>Firstname</th><th>Lastname</th><th>Nic</th><th>Email</th><th>Username</th><th>Password</th><th>Edit/Delete</th></tr>";
