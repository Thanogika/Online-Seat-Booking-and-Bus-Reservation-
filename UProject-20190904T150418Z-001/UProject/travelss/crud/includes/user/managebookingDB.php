...
echo '<thead>'; 
echo "<tr ><th>Staff Id</th><th>From</th><th>To</th><th>Date</th><th>Bus no</th><th>Bus type</th><th>No of seats</th><th>Seat no</th><th>Payment</th><th>View/Delete</th></tr>";
...
echo "<td>".$res['paid_amount']."</td>";
 echo "<td><a href=\"viewbooking.php?booking_id=$res[booking_id]\">View</a> | <a href=\"managebooking.php?booking_id=$res[booking_id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>"; 
