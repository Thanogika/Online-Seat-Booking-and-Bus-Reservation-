...
class bus extends databaseconnect{
 ...
 public function saveRecords($tbName,$bus_no,$no_of_seats,$bus_type,$from_station,$destination_station,$start_time,$end_time,$amount)
 {
 $conn=$this->connect();
 mysqli_query($conn,"insert into $tbName values('','".$bus_no."','".$no_of_seats."','".$bus_type."','".$from_station."','".$destination_station."','".$start_time."','".$end_time."','".$amount."','')");
 }
