   ...
   <section class="content">
      <div class="row">
       ...
       <table class="table table-bordered table-striped datatable">
        <tr ><th> Id</th><th>Title</th><th>Description</th><th>Photo</th><th>Action</th></tr>
...
// echo "<td><a href=\"editstaff.php?id=$res[id]\">Edit</a> | <a href=\"staff.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>"; 
  ...
  echo "<td><a class='btn btn-sm bg-olive show-busgetdetails'  href=\"viewnotifications.php?id=$res[id]\"> 
                              ...
                              <a class='btn btn-sm btn-primary' href=\"notifications/edit.php?id=$res[id]\">
                              <i class='fa fa-fw fa-edit'></i>Edit</a>
                              <a class='btn btn-sm btn-danger' href=\"notifications/delete.php?id=$res[id]\" onClick='return doconfirm()''>
